    ...
    <div class="flex flex-col lg:flex-row flex-wrap px-4 md:pl-8 md:pr-4 mb-4">
        <div class="flex items-center justify-center md:justify-start md:mr-4">
            <button
                ...
                class="rounded-xl hover:bg-black hover:bg-opacity-25 cursor-pointer p-2 focus:outline-none {elementFilter.electro ? '' : 'opacity-25'}"
            >
                <img
            ...
            <button
                ...
                class="rounded-xl hover:bg-black hover:bg-opacity-25 cursor-pointer p-2 focus:outline-none {elementFilter.anemo ? '' : 'opacity-25'}"
            >
                <img
            ...
            <button
                ...
                class="rounded-xl hover:bg-black hover:bg-opacity-25 cursor-pointer p-2 focus:outline-none {elementFilter.dendro ? '' : 'opacity-25'}"
            >
                <img
            ...
            <button
                ...
                class="rounded-xl hover:bg-black hover:bg-opacity-25 cursor-pointer p-2 focus:outline-none {elementFilter.hydro ? '' : 'opacity-25'}"
            >
                <img
            ...
            <button
                ...
                class="rounded-xl hover:bg-black hover:bg-opacity-25 cursor-pointer p-2 focus:outline-none {elementFilter.pyro ? '' : 'opacity-25'}"
            >
                <img
            ...
            <button
                ...
                class="rounded-xl hover:bg-black hover:bg-opacity-25 cursor-pointer p-2 focus:outline-none {elementFilter.cryo ? '' : 'opacity-25'}"
            >
                <img
            ...
            <button
                ...
                class="rounded-xl hover:bg-black hover:bg-opacity-25 cursor-pointer p-2 focus:outline-none {elementFilter.geo ? '' : 'opacity-25'}"
            >
                <img
        ...
        <div class="flex items-center justify-center md:justify-start md:mr-4">
            <button
                ...
                class="rounded-xl hover:bg-black hover:bg-opacity-25 cursor-pointer p-2 focus:outline-none {weaponFilter.catalyst ? '' : 'opacity-25'}"
            >
                <img
            ...
            <button
                ...
                class="rounded-xl hover:bg-black hover:bg-opacity-25 cursor-pointer p-2 focus:outline-none {weaponFilter.sword ? '' : 'opacity-25'}"
            >
                <img
            ...
            <button
                ...
                class="rounded-xl hover:bg-black hover:bg-opacity-25 cursor-pointer p-2 focus:outline-none {weaponFilter.polearm ? '' : 'opacity-25'}"
            >
                <img
            ...
            <button
                ...
                class="rounded-xl hover:bg-black hover:bg-opacity-25 cursor-pointer p-2 focus:outline-none {weaponFilter.bow ? '' : 'opacity-25'}"
            >
                <img
            ...
            <button
                ...
                class="rounded-xl hover:bg-black hover:bg-opacity-25 cursor-pointer p-2 focus:outline-none {weaponFilter.claymore ? '' : 'opacity-25'}"
            >
                <img
